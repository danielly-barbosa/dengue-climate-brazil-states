...
# Adaptado para usar dados de temp_min e rel_humid_med
...
# Diretórios - ADAPTADO PARA DADOS TEMP_MIN + REL_HUMID_MED
setwd("d:/CÓDIGOS")
dir.create("indexP_tempMin_humMed", showWarnings = FALSE)

# DIRETÓRIO CORRETO - NOSSOS DADOS COM TEMP_MIN + REL_HUMID_MED
dir_clima <- "d:/CÓDIGOS/dados_mvse_cidades_tempMin_humMed"
...
# FUNÇÃO EXTREMA DE PROCESSAMENTO - ADAPTADA PARA TEMP_MIN + REL_HUMID_MED
processar_cidade_extremo <- function(arquivo_clima) {
  tryCatch({
    ...
    # Priors otimizados para temp_min e rel_humid_med
...
# INÍCIO DO PROCESSAMENTO EXTREMO COM TEMP_MIN + REL_HUMID_MED
