...
def criar_csvs_por_cidade():
    ...
    # Diretório de saída
    dir_saida = r"d:\CÓDIGOS\dados_mvse_cidades_tempMin_humidMed"
    ...
    for _, row in df_geocodes.iterrows():
        ...
        try:
            ...
            # Remover geocode (não necessário no arquivo final)
            df_cidade = df_cidade.drop('geocode', axis=1)
            
            # Renomear colunas para padrão MVSE (T, H, R)
            ...
            # Salvar arquivo usando geocode como nome
