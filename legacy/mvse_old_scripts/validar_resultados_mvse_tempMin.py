...
def validar_resultados_mvse():
    ...
    # Arquivo consolidado
    arquivo_consolidado = r"d:\CÓDIGOS\resultados_MVSE_tempMin_consolidado.csv"
    ...
    # Verificar consistência dos intervalos de confiança
    ...
    # Cidades com IndexP mais alto/baixo
    ...
    # Verificar continuidade temporal por cidade
    cidades_com_gaps = 0
    for cidade in df['cidade'].unique()[:10]:  # Verificar apenas primeiras 10 cidades
    ...
    relatorio_arquivo = r"d:\CÓDIGOS\relatorio_validacao_MVSE_tempMin.txt"
