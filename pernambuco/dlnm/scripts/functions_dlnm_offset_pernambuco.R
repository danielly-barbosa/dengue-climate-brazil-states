...
prepare_base_with_population <- function(data_dir, summaries_dir, start_year = 2017, end_year = 2024) {
  show_progress(sprintf("Leitura das bases para Pernambuco (janela %d-%d).", start_year, end_year))
  show_progress("Periodo padrao (2017-2024) reflete a janela completa do InfoDengue/Sprint 2024-2025.")
  show_progress("Para estudos cobrindo 2010-2016, sobrescreva via prepare_base_with_population(..., start_year=2010).")
